...
public class BackgroundInput extends JPanel {
	...
	private float easeInOutCirc(float x) {
		double v = x < 0.5 ? (1 - Math.sqrt(1 - Math.pow(2 * x, 2))) / 2
	...
	public void paint(Graphics grphcs) {
		...
		g2.setColor(EnumColor.Focus5.color);
		g2.fill(createShape(height, 50, 70, 50, 100));
		g2.setColor(EnumColor.Focus4.color);
		g2.fill(createShape(height, 80, 50, 100, 50, 100, 50));
		g2.setColor(EnumColor.Focus3.color);
